...
/** @type {string} */
const CACHE_VERSION = '1745023772|27112937538';
/** @type {string} */
const CACHE_PREFIX = 'CrazyCattle3D-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'CrazyCattle3D2.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["CrazyCattle3D2.html","CrazyCattle3D2.js","CrazyCattle3D2.offline.html","CrazyCattle3D2.audio.worklet.js","CrazyCattle3D2.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["CrazyCattle3D2.wasm","CrazyCattle3D2.pck"];
